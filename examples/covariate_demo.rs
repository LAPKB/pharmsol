...
fn main() {
    ...
    // Test interpolation
    println!(
        "Weight at time 6.0: {:.1} kg",
        covariates
            .get_covariate_mut("weight")
            .unwrap()
            .interpolate(6.0)
            .unwrap()
    );
    println!(
        "Weight at time 18.0: {:.1} kg",
        covariates
            .get_covariate_mut("weight")
            .unwrap()
            .interpolate(18.0)
    ...
    println!(
        "Age at time 100.0: {:.1} years",
        covariates
            .get_covariate_mut("age")
            .unwrap()
            .interpolate(100.0)
            .unwrap()
    );
    ...
    println!(
        "Weight at time 6.0 after update: {:.1} kg",
        covariates
            .get_covariate_mut("weight")
            .unwrap()
            .interpolate(6.0)
    ...
    println!(
        "Weight at time 18.0 after update: {:.1} kg",
        covariates
            .get_covariate_mut("weight")
            .unwrap()
            .interpolate(18.0)
    ...
    println!(
        "Weight at time 6.0 with carry forward: {:.1} kg",
        covariates
            .get_covariate_mut("weight")
            .unwrap()
            .interpolate(6.0)
    ...
    pmetrics_data.insert(
        "bmi".to_string(),
        vec![(0.0, Some(25.0)), (30.0, Some(24.5))],
    );
    ...
    println!(
        ...
        pmetrics_covariates
            .get_covariate("bmi")
            .unwrap()
            .interpolate_immutable(15.0)
            .unwrap()
    );
    println!(
        "Sex at time 50.0 (fixed): {:.0}",
        pmetrics_covariates
            .get_covariate("sex")
            .unwrap()
            .interpolate_immutable(50.0)
            .unwrap()
    );
