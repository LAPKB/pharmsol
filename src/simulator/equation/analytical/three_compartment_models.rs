...
/// Assumptions:
///   - p is a vector of length 5 with ke, k12, k13, k21 and k31 in that order.
///     ke represents the elimination rate constant from compartment 1 (central).
...
pub fn three_compartments(x: &V, p: &V, t: T, rateiv: V, _cov: &Covariates) -> V {
    ...
    let a = ke + k12 + k13 + k21 + k31;
    let b = ke * k21 + k13 * k21 + ke * k31 + k12 * k31 + k21 * k31;
    let c = ke * k21 * k31;
    ...
    let c13 = ((ke + k12 + k13 - l1) * (k31 - l1) - (k13 * k31)) / ((l2 - l1) * (l3 - l1));
    let c14 = ((ke + k12 + k13 - l2) * (k31 - l2) - (k13 * k31)) / ((l1 - l2) * (l3 - l2));
    let c15 = ((ke + k12 + k13 - l3) * (k31 - l3) - (k13 * k31)) / ((l1 - l3) * (l2 - l3));
    ...
    let c25 = ((ke + k12 + k13 - l1) * (k21 - l1) - (k12 * k21)) / ((l2 - l1) * (l3 - l1));
    let c26 = ((ke + k12 + k13 - l2) * (k21 - l2) - (k12 * k21)) / ((l1 - l2) * (l3 - l2));
    let c27 = ((ke + k12 + k13 - l3) * (k21 - l3) - (k12 * k21)) / ((l1 - l3) * (l2 - l3));
...
/// Assumptions:
///   - p is a vector of length 6 with ka, ke, k23, k24, k32 and k42 in that order.
...
mod tests {
    ...
    fn test_three_compartments() {
        ...
        let ode = equation::ODE::new(
            |x, p, _t, dx, b, rateiv, _cov| {
                fetch_params!(p, ke, k23, k24, k32, k42, _v);
    ...
    fn test_three_compartments_with_absorption() {
        ...
        let ode = equation::ODE::new(
            |x, p, _t, dx, b, rateiv, _cov| {
                fetch_params!(p, ka, ke, k23, k24, k32, k42, _v);
