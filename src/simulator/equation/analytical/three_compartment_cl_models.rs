...
mod tests {
    ...
    fn test_three_compartments_cl() {
        ...
        let op_ode = ode
            .estimate_predictions(&subject, &crate::Parameters::dense([0.1, 3.0, 2.0, 1.0, 3.0, 4.0]))
            .unwrap();
    ...
    fn test_three_compartments_cl_with_absorption() {
        ...
        let op_ode = ode
            .estimate_predictions(&subject, &crate::Parameters::dense([1.0, 0.1, 3.0, 2.0, 1.0, 3.0, 4.0]))
            .unwrap();
        let op_analytical = analytical
            .estimate_predictions(&subject, &crate::Parameters::dense([1.0, 0.1, 3.0, 2.0, 1.0, 3.0, 4.0]))
            .unwrap();
