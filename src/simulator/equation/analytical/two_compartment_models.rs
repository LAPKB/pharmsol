        ...
        fn get_subject(&self) -> Subject {
            match self {
                SubjectInfo::InfusionDosing => Subject::builder("id1")
                    ...
                    .observation(0.0, Some(0.0), 0, None)
                    .observation(1.0, Some(0.0), 0, None)
                    .observation(2.0, Some(0.0), 0, None)
                    .observation(4.0, Some(0.0), 0, None)
                    .observation(8.0, Some(0.0), 0, None)
                    .observation(12.0, Some(0.0), 0, None)
                    .observation(24.0, Some(0.0), 0, None)
                    .observation(25.0, Some(0.0), 0, None)
                    .observation(26.0, Some(0.0), 0, None)
                    .observation(27.0, Some(0.0), 0, None)
                    .observation(28.0, Some(0.0), 0, None)
                    .observation(32.0, Some(0.0), 0, None)
                    .observation(36.0, Some(0.0), 0, None)
                    .build(),
                ...
                SubjectInfo::OralInfusionDosage => Subject::builder("id1")
                    ...
                    .observation(32.0, Some(0.0), 0, None)
                    .observation(36.0, Some(0.0), 0, None)
                    .observation(48.0, Some(0.0), 0, None)
                    .observation(49.0, Some(0.0), 0, None)
                    .observation(50.0, Some(0.0), 0, None)
                    .observation(52.0, Some(0.0), 0, None)
                    .observation(56.0, Some(0.0), 0, None)
                    .observation(60.0, Some(0.0), 0, None)
                    .build(),
            }
        }
    }
