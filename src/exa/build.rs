...
pub fn emit_ir<E: Equation>(
    ...
    // Extract structured lag/fa maps from textual macro content so emitted IR
    // contains structured maps that the runtime can consume without reparsing.
    fn extract_macro_map(src: &str, mac: &str) -> std::collections::HashMap<usize, String> {
