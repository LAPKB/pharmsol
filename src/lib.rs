...
pub use pharmsol_macros::{Params, Covariates};
...
pub mod prelude {
    ...
    pub use crate::{Params, CovariateSet};
    ...
    macro_rules! __diffeq_var {
        (x, $x:expr, $p:expr, $t:expr, $dx:expr, $bolus:expr, $rateiv:expr, $cov:expr) => { $x };
        (p, $x:expr, $p:expr, $t:expr, $dx:expr, $bolus:expr, $rateiv:expr, $cov:expr) => { $p };
        (t, $x:expr, $p:expr, $t:expr, $dx:expr, $bolus:expr, $rateiv:expr, $cov:expr) => { $t };
        (dx, $x:expr, $p:expr, $t:expr, $dx:expr, $bolus:expr, $rateiv:expr, $cov:expr) => { $dx };
        (bolus, $x:expr, $p:expr, $t:expr, $dx:expr, $bolus:expr, $rateiv:expr, $cov:expr) => { $bolus };
        (rateiv, $x:expr, $p:expr, $t:expr, $dx:expr, $bolus:expr, $rateiv:expr, $cov:expr) => { $rateiv };
        (cov, $x:expr, $p:expr, $t:expr, $dx:expr, $bolus:expr, $rateiv:expr, $cov:expr) => { $cov };
    }
    ...
    macro_rules! __out_var {
        (x, $x:expr, $p:expr, $t:expr, $cov:expr, $y:expr) => { $x };
        (p, $x:expr, $p:expr, $t:expr, $cov:expr, $y:expr) => { $p };
        (t, $x:expr, $p:expr, $t:expr, $cov:expr, $y:expr) => { $t };
        (cov, $x:expr, $p:expr, $t:expr, $cov:expr, $y:expr) => { $cov };
        (y, $x:expr, $p:expr, $t:expr, $cov:expr, $y:expr) => { $y };
    }
    ...
    macro_rules! __lag_fa_var {
        (p, $p:expr, $t:expr, $cov:expr) => { $p };
        (t, $p:expr, $t:expr, $cov:expr) => { $t };
        (cov, $p:expr, $t:expr, $cov:expr) => { $cov };
    }
    ...
    macro_rules! __init_var {
        (p, $p:expr, $t:expr, $cov:expr, $x:expr) => { $p };
        (t, $p:expr, $t:expr, $cov:expr, $x:expr) => { $t };
        (cov, $p:expr, $t:expr, $cov:expr, $x:expr) => { $cov };
        (x, $p:expr, $t:expr, $cov:expr, $x:expr) => { $x };
    }
}
