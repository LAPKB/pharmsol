...
mod tests {
    ...
    fn test_additive_error_model() {
        let observation = Observation::new(0.0, Some(20.0), 0, None, Censor::None);
    ...
    fn test_error_models_sigma_invalid_outeq() {
        ...
        let observation = Observation::new(0.0, Some(20.0), 1, None, Censor::None); // outeq=1 not in models
        let prediction = observation.to_prediction(10.0, vec![]);
    ...
    fn test_error_models_with_predictions_different_outeqs() {
        ...
        let obs1 = Observation::new(0.0, Some(20.0), 0, None, Censor::None);
        ...
        let obs2 = Observation::new(0.0, Some(20.0), 1, None, Censor::None);
